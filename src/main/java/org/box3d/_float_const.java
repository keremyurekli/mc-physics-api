...
public class _float_const {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        MemoryLayout.sequenceLayout(4, Box3D.C_SHORT).withName("_Word"),
        Box3D.C_FLOAT.withName("_Float"),
        Box3D.C_DOUBLE.withName("_Double"),
        Box3D.C_LONG_DOUBLE.withName("_Long_double")
    ).withName("$anon$259:9");
    ...
    private static final long _Word$OFFSET = $LAYOUT.byteOffset(groupElement("_Word"));
    ...
    public static short _Word(MemorySegment union, long index0) {
        return (short)_Word$ELEM_HANDLE.get(union, _Word$OFFSET, index0);
    }
    ...
    public static void _Word(MemorySegment union, long index0, short fieldValue) {
        _Word$ELEM_HANDLE.set(union, _Word$OFFSET, index0, fieldValue);
    }
    ...
    private static final long _Float$OFFSET = $LAYOUT.byteOffset(groupElement("_Float"));
    ...
    private static final long _Double$OFFSET = $LAYOUT.byteOffset(groupElement("_Double"));
    ...
    private static final long _Long_double$OFFSET = $LAYOUT.byteOffset(groupElement("_Long_double"));
