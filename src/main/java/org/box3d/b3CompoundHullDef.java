 ...
 * }
 */
public class b3CompoundHullDef {
    ...
    private static final AddressLayout hull$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("hull"));
    ...
    private static final long hull$OFFSET = $LAYOUT.byteOffset(groupElement("hull"));
